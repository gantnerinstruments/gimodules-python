...
def define_heat_map(
    ...
    diff = _distance(
        pivot_hm.shape[1], len(pivot_hm.columns.levels[2])
    )  # DIRTY FIX for mod difference (set_xticks and set_xticklabels) remove this if breaks
